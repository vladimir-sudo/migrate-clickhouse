...
module.exports = async (client) => {
  ...
  if (lastAppliedItem) {
    ...
    try {
      ...
      await client.query(`TRUNCATE ${changelogCollectionName};`).toPromise();
      await client.insert(`INSERT INTO ${changelogCollectionName} (fileName, fileHash, appliedAt)`, insertMigrations).toPromise();
